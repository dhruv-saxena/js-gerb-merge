...
(function () {
    ...
    var panZoomFunctions = {
        ...
        */
        ...
        //Dhruv - Added new function to multiply the movement of PCB by this value(values reduces as zoom increases)
        //currZoom is the step value of zoom
        //Zoom happens because paper width reduces, so we reduce mouse x and y movement by same factor.    
        getZoomValue: function (){
            return (1-this.currZoom *0.1 );
        }
    },
